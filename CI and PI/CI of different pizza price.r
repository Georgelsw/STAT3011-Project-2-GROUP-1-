...
+annotate("text",x=1,y=12.2,label="M=11.96")+annotate("text",x=2,y=12.2,label="M=11.96")
+annotate("text",x=1,y=8.3,label="8.53")+annotate("text",x=1,y=14.3,label="14.18")
+annotate("text",x=2,y=8.3,label="8.53")+annotate("text",x=2,y=13.5,label="13.39")
